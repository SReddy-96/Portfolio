...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <Box className="drawer">
            ...
            <Box sx={{ my: 3 }}>
                <a className="socialIcon" aria-label="GitHub link" target="_blank" href="https://github.com/SReddy-96" ><GitHubIcon fontSize="medium" /></a>
                <a className="socialIcon" aria-label="Instagram link" target="_blank" href="https://instagram.com/justa_steve/"><InstagramIcon fontSize="medium" /></a>
                <a className="socialIcon" aria-label="Linkedin link" target="_blank" href="https://www.linkedin.com/in/steven-reddy-912b0b299"><LinkedInIcon fontSize="medium" /></a>
                <a className="socialIcon" aria-label="X link" target="_blank" href="https://www.x.com/SReddy_96"><XIcon fontSize="medium" /></a>
            </Box>
        </Box >
    );
